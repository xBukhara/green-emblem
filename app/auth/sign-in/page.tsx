...
function SignInInner() {
  ...
  return (
    <div style={{ minHeight:'100dvh', display:'flex', alignItems:'center', justifyContent:'center', padding:'24px', position:'relative', zIndex:2 }}>
      <div style={{
        background:'rgba(15,31,15,0.75)', border:'0.5px solid rgba(212,175,110,0.2)',
        borderRadius:'20px', padding:'40px 36px', width:'100%', maxWidth:'400px',
        ...
        <h1 style={{ fontFamily:'var(--font-cinzel)', fontSize:'22px', fontWeight:500, color:'#fff', marginBottom:'8px' }}>
          Green Emblem
        </h1>
        ...
        {error && (
          <div style={{ background:'rgba(226,75,74,0.1)', border:'0.5px solid rgba(226,75,74,0.3)', borderRadius:'8px', padding:'10px 14px', marginBottom:'16px', fontSize:'13px', color:'#e24b4a' }}>
            {error}
          </div>
        )}
        ...
        <button
          ...
          style={{
            ...
            padding:'14px 20px', fontFamily:'var(--font-cormorant)', fontSize:'17px',
