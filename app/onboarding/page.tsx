          ...
          {step === 2 && (
            <div style={{ padding: '28px' }}>
              ...
              <p style={{ fontFamily: 'Georgia, serif', fontSize: '13px', color: 'rgba(255,255,255,0.4)', fontStyle: 'italic', lineHeight: 1.6, marginBottom: '20px' }}>
                Used for party favour and shop deliveries. Saved securely.
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div style={{ background: 'rgba(212,175,110,0.06)', border: '0.5px solid rgba(212,175,110,0.2)', borderRadius: '12px', padding: '16px 18px' }}>
                  ...
                  <p style={{ fontFamily: 'Georgia, serif', fontSize: '13px', color: 'rgba(255,255,255,0.55)', lineHeight: 1.75, fontStyle: 'italic' }}>
                    This information helps us build a centralized access system for Muslims across the USA — connecting you to your favorite mosques, local community events, networking opportunities, Islamic businesses, and affiliate programs near you. Your address is saved for shipping purposes only. We never sell your data.
                  </p>
                </div>
